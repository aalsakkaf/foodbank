                ...
                @if (session('status'))
                 ...
                 <div class="card">
                    ...
                    <fieldset>
                        ...
                        <legend>Step 1: Enter Your main details</legend>
                        <div class="form-group">
                            <label for="title" class="col-xs-2 control-label">Title</label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="name" name="title">
                            </div>
                            <label for="details" class="col-xs-2 control-label">Details</label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="details" name="details">
                            </div>
                            <label for="availableDate" class="col-xs-2 control-label">Availablility </label>
                            <div class="col-lg-10">
